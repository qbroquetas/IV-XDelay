    ...
    : AudioProcessorEditor(ownerProc), processor(ownerProc)
{
    ...
    input_gain_slider->setRange (0.125, 8, 0.001);
    ...
    input_gain_slider->setSkewFactor (0.45);

    addAndMakeVisible (output_gain_slider = new Slider ("Output Gain"));
    output_gain_slider->setRange (0.125, 8, 0.001);
    ...
    output_gain_slider->setSkewFactor (0.45);
    ...
    delay_time_slider->setSkewFactor (0.4);

    addAndMakeVisible (label3 = new Label ("new label",
                                           TRANS("Time [ms]")));
    label3->setFont (Font (14.30f, Font::plain));
    ...
    feedback_gain_slider->setRange (0, 1.5, 0.01);
    ...
    feedback_gain_slider->setSkewFactor (0.65);

    addAndMakeVisible (label4 = new Label ("new label",
                                           TRANS("Feedback")));
    label4->setFont (Font (14.30f, Font::plain));
    ...
    wow_rate_slider->setRange (0.1, 4, 0.01);
    ...
    wow_rate_slider->setSkewFactor (0.5);

    addAndMakeVisible (wow_amt_slider = new Slider ("Wow Amt"));
    wow_amt_slider->setRange (0, 1, 0.01);
    ...
    wow_amt_slider->setSkewFactor (0.65);

    addAndMakeVisible (flutter_amt_slider = new Slider ("Flutter Rate"));
    flutter_amt_slider->setRange (0, 1, 0.01);
    ...
    flutter_amt_slider->setSkewFactor (0.65);
    ...
    flutter_rate_slider->setSkewFactor (0.75);

    addAndMakeVisible (label5 = new Label ("new label",
                                           TRANS("Wow")));
    label5->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label6 = new Label ("new label",
                                           TRANS("Flutter")));
    label6->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label7 = new Label ("new label",
                                           TRANS("Rate:")));
    label7->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label8 = new Label ("new label",
                                           TRANS("Amt:")));
    label8->setFont (Font (14.30f, Font::plain));
    ...
    scrape_amt_slider->setRange (0, 1, 0.01);
    ...
    scrape_amt_slider->setSkewFactor (0.65);

    addAndMakeVisible (label9 = new Label ("new label",
                                           TRANS("Scrape")));
    label9->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label10 = new Label ("new label",
                                            TRANS("Bias")));
    label10->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label12 = new Label ("new label",
                                            TRANS("3.75")));
    label12->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label13 = new Label ("new label",
                                            TRANS("15")));
    label13->setFont (Font (14.30f, Font::plain));
    ...
    addAndMakeVisible (label14 = new Label ("new label",
                                            TRANS("7.5")));
    label14->setFont (Font (14.30f, Font::plain));
    ...
    IPS_slider->setSkewFactor (0.65);

    addAndMakeVisible (noise_level_slider = new Slider ("Noise Level"));
    noise_level_slider->setRange (0.01, 4, 0.01);
    ...
    noise_level_slider->setSkewFactor (0.6);

    addAndMakeVisible (label15 = new Label ("new label",
                                            TRANS("Noise")));
    label15->setFont (Font (13.80f, Font::plain));
...
<JUCER_COMPONENT documentType="Component" className="IvxDelayAudioProcessorEditor"
  ...
  <SLIDER name="Input Gain" id="a8530061fa26205a" memberName="input_gain_slider"
          ...
          textboxbkgd="880f00" textboxoutline="808080" min="0.125" max="8"
          int="0.0010000000000000000208" style="RotaryHorizontalVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="0" textBoxWidth="50"
          textBoxHeight="10" skewFactor="0.4500000000000000111" needsCallback="0"/>
  <SLIDER name="Output Gain" id="1cac91e81f7ffc98" memberName="output_gain_slider"
          ...
          textboxbkgd="f5100" textboxoutline="808080" min="0.125" max="8"
          int="0.0010000000000000000208" style="RotaryHorizontalVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="0" textBoxWidth="50"
          textBoxHeight="10" skewFactor="0.4500000000000000111" needsCallback="0"/>
  ...
  <SLIDER name="Delay Time" id="17625408a19875d7" memberName="delay_time_slider"
          ...
          textBoxEditable="0" textBoxWidth="50" textBoxHeight="10" skewFactor="0.4000000000000000222"
          needsCallback="0"/>
  <LABEL name="new label" id="2bea1b081658bdc0" memberName="label3" virtualName=""
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="14.300000000000000711" bold="0" italic="0" justification="33"/>
  <SLIDER name="Feedback Gain" id="c4f37ca2e1c5fa2b" memberName="feedback_gain_slider"
          ...
          rotarysliderfill="ffff8600" rotaryslideroutline="ffb55f00" textboxtext="ffda6a00"
          textboxbkgd="f5100" textboxoutline="808080" min="0" max="1.5"
          int="0.010000000000000000208" style="RotaryHorizontalVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="0" textBoxWidth="50"
          textBoxHeight="10" skewFactor="0.6500000000000000222" needsCallback="0"/>
  ...
  <SLIDER name="Wow Rate" id="41826fcacc032854" memberName="wow_rate_slider"
          ...
          textboxbkgd="f5100" textboxoutline="808080" min="0.10000000000000000555"
          max="4" int="0.010000000000000000208" style="RotaryHorizontalVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="0" textBoxWidth="40"
          textBoxHeight="10" skewFactor="0.5" needsCallback="0"/>
  <SLIDER name="Wow Amt" id="d43d7e188f04c376" memberName="wow_amt_slider"
          ...
          textboxbkgd="f5100" textboxoutline="808080" min="0" max="1" int="0.010000000000000000208"
          style="RotaryHorizontalVerticalDrag" textBoxPos="NoTextBox" textBoxEditable="0"
          textBoxWidth="40" textBoxHeight="10" skewFactor="0.6500000000000000222"
          needsCallback="0"/>
  ...
  <SLIDER name="Flutter Rate" id="bf612f9a3b3abf56" memberName="flutter_rate_slider"
          ...
          int="1" style="RotaryHorizontalVerticalDrag" textBoxPos="TextBoxBelow"
          textBoxEditable="0" textBoxWidth="40" textBoxHeight="10" skewFactor="0.75"
          needsCallback="0"/>
  ...
  <LABEL name="new label" id="787b4540dbb2daa" memberName="label12" virtualName=""
         ...
         focusDiscardsChanges="0" fontname="Default font" fontsize="14.300000000000000711"
  ...
  <SLIDER name="IPS" id="2bef45ac47ec5769" memberName="IPS_slider" virtualName=""
          ...
          style="RotaryHorizontalVerticalDrag" textBoxPos="NoTextBox" textBoxEditable="0"
          textBoxWidth="50" textBoxHeight="10" skewFactor="0.6500000000000000222"
          needsCallback="0"/>
  <SLIDER name="Noise Level" id="41764f6f8519b875" memberName="noise_level_slider"
          ...
          textboxbkgd="f5100" textboxoutline="808080" min="0.010000000000000000208"
          max="4" int="0.010000000000000000208" style="RotaryHorizontalVerticalDrag"
          textBoxPos="NoTextBox" textBoxEditable="0" textBoxWidth="40"
          textBoxHeight="10" skewFactor="0.5999999999999999778" needsCallback="0"/>
  <LABEL name="new label" id="159869caecdd7ce" memberName="label15" virtualName=""
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="13.800000000000000711" bold="0" italic="0" justification="33"/>
</JUCER_COMPONENT>
